...
def load_sprites():
    ...
    sprites['puck']        = pygame.image.load(dir_path + '/sprites/puck/puck.png')
    ...
    sprites['top_mallet']    = pygame.image.load(dir_path + '/sprites/mallet/redpad.png')
    sprites['bottom_mallet'] = pygame.image.load(dir_path + '/sprites/mallet/bluepad.png')
...
def blit_puck(game, puck):
    ...
    if game.dim.rink_top + game.dim.puck_radius <= puck[1] <= game.dim.rink_bottom - game.dim.puck_radius:
        game.screen.blit(game.sprites['puck'], (puck - game.dim.puck_radius).tolist())
    elif game.dim.rink_top - game.dim.puck_radius <= puck[1] <= game.dim.center[1]:
        if game.dim.rink_top + game.dim.puck_radius * 0.7 <= puck[1]:
            game.screen.blit(game.sprites['puck_top'][6], (puck - game.dim.puck_radius).tolist())
        elif game.dim.rink_top + game.dim.puck_radius * 0.4 <= puck[1]:
            game.screen.blit(game.sprites['puck_top'][5], (puck - game.dim.puck_radius).tolist())
        elif game.dim.rink_top + game.dim.puck_radius * 0.1 <= puck[1]:
            game.screen.blit(game.sprites['puck_top'][4], (puck - game.dim.puck_radius).tolist())
        elif game.dim.rink_top - game.dim.puck_radius * 0.1 <= puck[1]:
            game.screen.blit(game.sprites['puck_top'][3], (puck - game.dim.puck_radius).tolist())
        elif game.dim.rink_top - game.dim.puck_radius * 0.4 <= puck[1]:
            game.screen.blit(game.sprites['puck_top'][2], (puck - game.dim.puck_radius).tolist())
        elif game.dim.rink_top - game.dim.puck_radius * 0.7 <= puck[1]:
            game.screen.blit(game.sprites['puck_top'][1], (puck - game.dim.puck_radius).tolist())
        elif game.dim.rink_top - game.dim.puck_radius       <= puck[1]:
            game.screen.blit(game.sprites['puck_top'][0], (puck - game.dim.puck_radius).tolist())
        ...
        if   puck[1] <= game.dim.rink_bottom - game.dim.puck_radius * 0.7:
            game.screen.blit(game.sprites['puck_bottom'][6], (puck - game.dim.puck_radius).tolist())
        elif puck[1] <= game.dim.rink_bottom - game.dim.puck_radius * 0.4:
            game.screen.blit(game.sprites['puck_bottom'][5], (puck - game.dim.puck_radius).tolist())
        elif puck[1] <= game.dim.rink_bottom - game.dim.puck_radius * 0.1:
            game.screen.blit(game.sprites['puck_bottom'][4], (puck - game.dim.puck_radius).tolist())
        elif puck[1] <= game.dim.rink_bottom + game.dim.puck_radius * 0.1:
            game.screen.blit(game.sprites['puck_bottom'][3], (puck - game.dim.puck_radius).tolist())
        elif puck[1] <= game.dim.rink_bottom + game.dim.puck_radius * 0.4:
            game.screen.blit(game.sprites['puck_bottom'][2], (puck - game.dim.puck_radius).tolist())
        elif puck[1] <= game.dim.rink_bottom + game.dim.puck_radius * 0.7:
            game.screen.blit(game.sprites['puck_bottom'][1], (puck - game.dim.puck_radius).tolist())
        elif puck[1] <= game.dim.rink_bottom + game.dim.puck_radius:
            game.screen.blit(game.sprites['puck_bottom'][0], (puck - game.dim.puck_radius).tolist())

def generate_puck_sprites():
    ''' Utility function to generate sprites that will simulate the puck going inside the goal area '''

    image = Image.open('sprites/puck/puck.png')
